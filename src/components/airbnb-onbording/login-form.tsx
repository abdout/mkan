...
export function LoginSignupModal({ isOpen, onClose }: LoginSignupModalProps) {
  const [selectedCountry, setSelectedCountry] = useState("United Kingdom (+44)")
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[520px] p-0 gap-0">
        ...
        <div className="px-6 py-8 space-y-6">
          {/* Welcome Text */}
          <h3 className="text-[22px] font-medium text-gray-900 leading-tight tracking-wide">
            Welcome to Airbnb
          </h3>
            ...
            <div className="space-y-0">
              ...
              <div className="relative w-full">
                <Select value={selectedCountry} onValueChange={setSelectedCountry}>
                  <SelectTrigger 
                    className="w-full rounded-b-none border-b-0 h-[70px] px-3 py-2 text-left focus:ring-0 focus:ring-offset-0 focus:border-gray-900"
                  >
                    <div className="flex flex-col items-start gap-1">
                      <Label className="text-xs text-gray-500 font-normal">
                        Country/Region
                      </Label>
                      <SelectValue className="text-base text-gray-900" />
                    </div>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Germany (+49)">Germany (+49)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              {/* Phone Number Input */}
              <div className="relative w-full">
                <div className="border border-gray-300 rounded-t-none rounded-b-lg px-3 py-2 h-[70px] flex flex-col gap-1 justify-center focus-within:border-gray-900 focus-within:border-2">
                  <Label className="text-xs text-gray-500 font-normal">
                    Phone number
                  </Label>
                  <input
                    ...
                    className="w-full border-0 p-0 text-base font-normal bg-transparent focus:outline-none"
                    placeholder=""
                  />
                </div>
              </div>
