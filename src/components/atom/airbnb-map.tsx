      ...
      <div className="relative w-full h-[400px] mb-6 rounded-lg overflow-hidden border border-[#e5e7eb]">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
          ...
          <div className="relative bg-[#ffffff] shadow-lg border border-[#e5e7eb] px-4 py-2 mb-4">
            ...
            {/* Down arrow */}
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-5 border-r-5 border-t-5 border-l-transparent border-r-transparent border-t-[#ffffff]"></div>
          </div>
        ...
        <div className="absolute bottom-4 right-4 flex gap-1">
          <Button size="icon" variant="outline" className="w-7 h-7 rounded-full bg-[#ffffff] border-[#e5e7eb] hover:bg-[#e5e7eb]">
